  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput
        ...
        autoCapitalize="none"
      />
      <TouchableOpacity style={styles.button} onPress={handleChangeInfo} disabled={loading}>
        <Text style={styles.buttonText}>{loading ? <ActivityIndicator size={25} color="white" /> : 'Save'}</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
