      ...
      <View style={styles.contentContainer}>
        <View style={styles.cardContainer}>
          <View style={styles.header}>
            <Text style={styles.status}>{latestOngoingBooking.driverId ? latestOngoingBooking.isDropoff ? "Good" : "Waiting" : "Not Confirmed "}</Text>
            ...
            <View style={styles.locationContainer}>
                <View style={styles.locationDiv}>
                    <Image
                        ...
                        source={{uri: (latestOngoingBooking && latestOngoingBooking.profilePicture) || 'https://i.stack.imgur.com/l60Hf.png'}} 
                    />
            ...
            <Text>Total of <Text style={{fontWeight: 'bold', fontSize: 18}}>{latestOngoingBooking.ridePrice}</Text></Text>
        </View>
      </View>
    </SafeAreaView>
  )
